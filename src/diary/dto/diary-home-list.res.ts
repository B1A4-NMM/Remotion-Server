...
export class DiaryRes {
  ...
  @ApiProperty({example: 's3://remotion-photo/bcdc2b34-a81e-4d51-be65-d14c4423e193.jpg', description: '사진 경로들'})
  photoPath?: string[] | null = [];

  @ApiProperty({example: 's3://remotion-photo/69846643-6af1-4a79-b8b1-6ac134d.mp3', description: '음성 녹음 경로'})
